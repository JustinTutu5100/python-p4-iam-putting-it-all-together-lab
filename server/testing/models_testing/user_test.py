...
class TestUser:
    ...
    def test_requires_username(self):
        ...
        with app.app_context():
            ...
            user = User()
            user.password_hash = "dummy"  # must set to avoid NOT NULL error
            with pytest.raises(IntegrityError):
                db.session.add(user)
                db.session.commit()

            db.session.rollback()  # reset session after exception
    ...
    def test_requires_unique_username(self):
        ...
        with app.app_context():
            ...
            db.session.commit()  # first user inserted
    ...
    def test_has_list_of_recipes(self):
        ...
        with app.app_context():
            ...
            user.password_hash = "supersecurepassword"
            ...
            # Verify recipes attached to user
